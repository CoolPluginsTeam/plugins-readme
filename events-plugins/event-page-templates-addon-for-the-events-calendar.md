...
1. Search "event single page" inside your website **wp-admin dashboard >> Plugins >> Add New** and install **Event Single Page Builder** plugin. You can also install a plugin by uploading a plugin-zip unzipped folder to the **/wp-content/plugins** directory. You must install **The Event Calendar** free plugin if you want to use this plugin features.
